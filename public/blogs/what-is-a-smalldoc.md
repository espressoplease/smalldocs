---
file: what-is-a-smalldoc.md
title: A SmallDoc is a new type of document
---
...
sequenceDiagram
  ...
  participant CLI as sdoc CLI
  participant Browser
  You->>Agent: "sdoc me a report on Q2"
  Agent->>Agent: gather data, write report.md
  Agent->>CLI: sdoc report.md
  CLI->>Browser: open, render the styled doc
  Note over CLI,Browser: a local bridge keeps the browser<br/>in sync with the file on disk
  Browser-->>You: read, present, share
```
...
[![A SmallDocs library](https://smalldocs.org/public/images/library-sample.webp)](https://smalldocs.org/library?demo=1)
