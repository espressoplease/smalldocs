(function (exports) {
  ...
  function footerInnerHtml(statusId) {
    var status = statusId
      ? '<div id="' + statusId + '" class="sdocs-sidebar-status" aria-live="polite"></div>' : '';
    return status +
      ...
      '<div class="sdocs-sidebar-legal"><a href="/business" target="_blank" rel="noopener">For business</a>' +
      '<span aria-hidden="true">·</span><a href="/legal" target="_blank" rel="noopener">Terms</a></div>';
  }
  ...
  function hydrate(root) {
    ...
    Array.from(root.querySelectorAll('[data-sdocs-shared-footer]')).forEach(function (element) {
      element.innerHTML = footerInnerHtml(element.getAttribute('data-status-id'));
    });
  }
