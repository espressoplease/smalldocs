...
import { TRUSTED_TYPES_POLICY } from './version.js';
...
const POLICY_NAME = TRUSTED_TYPES_POLICY;
...
export function lexMarkdown(source) {
  return parser.lexer(String(source == null ? '' : source));
}
